...
export default function ConstellationGrid() {
    ...
    const [isDarkMode, setIsDarkMode] = useState<boolean>(true); // Forced dark mode for this theme
    ...
    return (
        <div className="absolute inset-0 w-full h-full overflow-hidden select-none bg-[#030407]">
